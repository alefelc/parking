                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6" id="divSaldoOrLogin">
                        ...
                        <div class="social-btns full">
                            <button type="button" class="btn btn-primary btn-lg">Todavía no estás inscripto?</button>
                            <p class="legend">
                                 Descargá la planilla para registrarte
                            </p>
                        </div>
                        <div class="tagline">
                        </div>
                        ...
                        <section>
                        <form action="#" method="get" accept-charset="utf-8" class="form-horizontal" role="form">                            
                                <div class="form-group has-feedback">
                                    <input type="text" class="form-control" id="dni" name="dni" placeholder="D.N.I." required="">
                                ...
                                <div class="form-group">
                                    <button class="btn btn-primary forget" data-toggle="modal" data-target=".bs-example-modal-sm">Olvidaste la contraseña?</button>
                                    <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                <form>
                                                    <div class="form-group has-feedback">
                                                        <input type="text" class="form-control" id="inputEmail3" placeholder="Tu Email" required="">
